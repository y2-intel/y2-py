...
from y2._utils import PropertyInfo
from y2._compat import PYDANTIC_V1, parse_obj, model_dump, model_json
from y2._models import DISCRIMINATOR_CACHE, BaseModel, EagerIterable, construct_type
