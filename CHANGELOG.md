...
* **api:** api update ([bb5abd5](https://github.com/y2-intel/y2-py/commit/bb5abd50337c364d00f193d4230d2b1288c6ab70))
* **internal/types:** support eagerly validating pydantic iterators ([302dd87](https://github.com/y2-intel/y2-py/commit/302dd87c2b3df0760d6b548eaaf52c126d42274e))
* support setting headers via env ([fb318a5](https://github.com/y2-intel/y2-py/commit/fb318a5404740aa0a464f7b2f53d16626f37ab16))


### Bug Fixes

* **client:** add missing f-string prefix in file type error message ([7ce6687](https://github.com/y2-intel/y2-py/commit/7ce6687cbf336c196216141d9a56473fca4c3768))
...
* **internal:** reformat pyproject.toml ([7a00ea5](https://github.com/y2-intel/y2-py/commit/7a00ea5f581583fd51b1a430a29e480d6e40dbb7))
