...
from ._exceptions import Y2Error, APIStatusError
...
class Y2(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Y2 client instance.

        This automatically infers the `api_key` argument from the `Y2_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("Y2_API_KEY")
        if api_key is None:
            raise Y2Error(
                "The api_key client option must be set either by passing api_key to the client or by setting the Y2_API_KEY environment variable"
            )
        ...
        custom_headers_env = os.environ.get("Y2_CUSTOM_HEADERS")
    ...
    def with_raw_response(self) -> Y2WithRawResponse:
        return Y2WithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> Y2WithStreamedResponse:
        return Y2WithStreamedResponse(self)
...
class AsyncY2(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncY2 client instance.
    ...
    @cached_property
    def with_streaming_response(self) -> AsyncY2WithStreamedResponse:
        return AsyncY2WithStreamedResponse(self)
...
class Y2WithRawResponse:
    _client: Y2

    def __init__(self, client: Y2) -> None:
        self._client = client
...
class AsyncY2WithRawResponse:
    ...
    def __init__(self, client: AsyncY2) -> None:
        self._client = client
